...
Currently ${numUnfundedGames.length} games remain unfunded. We need your help to fund these games!`
// create a new DOM element containing the template string and append it to the description container
var displayMoneyRaised = document.createElement("p");
displayMoneyRaised.innerHTML = displayStr;
descriptionContainer.append(displayMoneyRaised);
/************************************************************************************
...
var topPledgeGame = document.createElement("p");
topPledgeGame.innerHTML = String(first.name);
firstGameContainer.append(topPledgeGame);
// do the same for the runner up item
var runnerPledgeGame = document.createElement("p");
runnerPledgeGame.innerHTML = second.name;
secondGameContainer.append(runnerPledgeGame);
